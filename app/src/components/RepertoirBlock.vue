<template>
  <div id="het-repertoire" class="section section--het-repertoire" data-anchor="het-repertoire">
    <div class="container-fluid">
      <article class="flex-box" id="content-het-repertoire">
        ...
        <div class="list list--figure row" data-filter="">
          <div class="tag-cloud">
            <a
              data-group="a-capella"
              class="tag-cloud-link tag-link-12 tag-link-position-1"
              style="font-size: 12.2857pt; opacity: 1;"
              aria-label="A Capella (3 items)"
            ...
            <a
              ...
              style="font-size: 14.8571pt; opacity: 1;"
              aria-label="Ballads (5 items)"
              data-animate="bounceIn"
              >Ballads</a
            >
            <a
              ...
              style="font-size: 22pt; opacity: 1;"
              aria-label="Engels (18 items)"
              data-animate="bounceIn"
              >Engels</a
            >
            <a
              data-group="frans"
              class="tag-cloud-link tag-link-15 tag-link-position-4"
              style="font-size: 8pt; opacity: 1;"
              aria-label="Frans (1 item)"
              data-animate="bounceIn"
              >Frans</a
            >
            <a
              ...
              style="font-size: 15.8571pt; opacity: 1;"
              aria-label="Kerst (6 items)"
              data-animate="bounceIn"
              >Kerst</a
            >
            <a
              data-group="nederlands"
              class="tag-cloud-link tag-link-19 tag-link-position-6"
              style="font-size: 14.8571pt; opacity: 1;"
              aria-label="Nederlands (5 items)"
              data-animate="bounceIn"
              >Nederlands</a
            >
            <a
              data-group="pop"
              class="tag-cloud-link tag-link-21 tag-link-position-7"
              style="font-size: 13.7143pt; opacity: 1;"
              aria-label="Pop (4 items)"
              data-animate="bounceIn"
              >Pop</a
            >
            <a
              data-group="uptempo"
              class="tag-cloud-link tag-link-16 tag-link-position-8"
              style="font-size: 18.5714pt; opacity: 1;"
              aria-label="Uptempo (10 items)"
              data-animate="bounceIn"
              >Uptempo</a
            >
          </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/Meghan_Trainor_-_All_About_That_Bass_Official_Single_Cover.png"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/21650_chocolates-300x223.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/0b32fdc1c04cf3cee14930f3348d34dd_medium-300x240.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/1400x1400_8904117-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/large-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/Wicked-World-laura-jansen_0.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/frances.jpeg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/image243-225x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/Avicii_Wake_Me_Up_Official_Single_Cover-300x300.png"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/anouk-girllost.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/caro-emerald-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/enhanced-buzz-25287-1360269820-6-300x248.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/songwiki.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/chanson17.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/Winter_Light_Large-300x202.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/turn-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/9b4ad9e7869d06f23b5558f9afc39ae3.250x221x1.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/Destinys-Child-Bills-Bills-Bills-640x640-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/Adele_-_Make_You_Feel_My_Love-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/misje-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/zo-stil-in-mij-van-dik-hout-.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/John-Legend-All-Of-Me2-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/suddenly_i_see_plaatje-300x298.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/1443786538.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/kenjemij-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/girl.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/m38242nf1ys.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/empire.jpeg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/080689198274_5-201x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2018/04/clown.jpeg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/115154106-300x300.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/11/O-holy-night.jpg"
                      alt=""
                    />
                  </div>
              ...
              >
                <div class="list__content row">
                  <div class="list__figure col-xs-2 col-sm-3">
                    <img
                      class="content"
                      src="http://www.goedgebekt.com/core/wp-content/uploads/2016/09/2524537-300x295.jpg"
                      alt=""
                    />
                  </div>
    ...
    <div class="quotes">
      <section class="slick-initialized slick-slider" data-carousel="">
        <div aria-live="polite" class="slick-list">
          <div
            class="slick-track"
            style="opacity: 1; width: 2400px; transform: translate3d(-600px, 0px, 0px);"
            role="listbox"
          >
            <div
              class="quote slick-slide slick-cloned"
              data-slick-index="-1"
              id=""
              aria-hidden="true"
              style="width: 600px;"
            ...
            <div
              class="quote slick-slide slick-current slick-active"
              data-slick-index="0"
              aria-hidden="false"
              style="width: 600px;"
              tabindex="-1"
